...
const baseThemes: Record<Theme, BaseTheme> = {
  ...
  light: {
    ...
    border: '#d0d7de',
    textPrimary: '#1f2328', textSecondary: '#24292f', textMuted: '#656d76',
    accent: '#0969da',
  ...
  dracula: {
    ...
    border: '#6272a4',
    textPrimary: '#f8f8f2', textSecondary: '#e2e0ff', textMuted: '#8b9ec7',
    accent: '#bd93f9',
  ...
  nord: {
    ...
    border: '#4c566a',
    textPrimary: '#eceff4', textSecondary: '#e5e9f0', textMuted: '#81a1c1',
    accent: '#88c0d0',
  ...
  amoled: {
    ...
    border: '#222222',
    textPrimary: '#ffffff', textSecondary: '#e0e0e0', textMuted: '#909090',
    accent: '#00b4d8',
  ...
  sepia: {
    ...
    border: '#c8bfaf',
    textPrimary: '#2c2018', textSecondary: '#3d2e20', textMuted: '#7a6a59',
    accent: '#b5451b',
  ...
  everforest: {
    ...
    border: '#475258',
    textPrimary: '#d3c6aa', textSecondary: '#c5b7a3', textMuted: '#7a8478',
    accent: '#a7c080',
  ...
  rosepine: {
    ...
    border: '#dfd7cc',
    textPrimary: '#575279', textSecondary: '#4a485b', textMuted: '#9893a5',
    accent: '#b4637a',
  ...
  cyberpunk: {
    ...
    border: '#1a1a3e',
    textPrimary: '#e0e0ff', textSecondary: '#c0c0f0', textMuted: '#8080cc',
    accent: '#00e5ff',
...
export function buildCssVariablesResolver(dacTheme: Theme): CSSVariablesResolver {
  ...
  const allVars = {
    ...
    '--mantine-color-dimmed': colors['--text-muted'],
